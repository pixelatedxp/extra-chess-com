(() => {
  ...
  const FAKE_BADGE_TIERS = {
    ...
    platinum: {
      ...
      vb: "0 0 24 24",
      path:
        "m12.03 22.33c-7.23-.03-8.6-4.87-8.6-4.87l-1.3-13.47c-.1-1.03.1-1.1.73-.3l4.87 6.43 3.7-7.8c.43-.93.77-.93 1.2 0l3.63 7.8 4.87-6.4c.63-.8.83-.73.73.3l-1.27 13.43s-1.4 4.83-8.57 4.87zm0 0"
    }
  };
